...
- IDEs
    - [Visual Studio Code](https://code.visualstudio.com/Download)
        ...
        - if you want to use Maven with VSC you will need to download it and set it up for use: [this](https://maven.apache.org/download.cgi) link will take you to the download page, which also includes setup instructions for configuring Maven to work on your machine
    - [Intellij](https://www.jetbrains.com/idea/download/?fromIDE=&section=windows)
        ...
        - Intellij comes bundled with a Maven wrapper and has an internal system for downloading and using JDKS, when setting up a project you can have Intellij download the JDK you need
